...
namespace Rise.Gui
{
    public class GuiContainer : GuiElement
    {
        ...
        public GuiContainer(int sizeX, int sizeY, LayoutMode layout)
            : base(sizeX, sizeY)
        {
            this.layout = layout;
        }
        public GuiContainer(int sizeX, int sizeY)
            : this(sizeX, sizeY, LayoutMode.Vertical)
        {
            
        }
        public GuiContainer()
            : this(0, 0, LayoutMode.Vertical)
        {
        ...
        internal override void DoAddedToView(GuiView view)
        {
        ...
        internal override void DoDrop(GuiElement elem)
        {
            base.DoDrop(elem);
        ...
        public T AddChild<T>(T child) where T : GuiElement
        {
        ...
        public T RemoveChild<T>(T child) where T : GuiElement
        {
